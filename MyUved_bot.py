...
# ... (продолжение обработчиков: weekdays, save_notification, edit, delete, settings и т.д.)
# ВАЖНО: Остальные обработчики (weekdays_done, set_every_day_time, set_weekday_time, 
# save_notification, set_hours, set_days, set_months, set_specific_date, 
# save_edited_notification, snooze, complete, edit, delete, settings_menu, 
# toggle_notifications, и все остальные) должны быть включены в файл.
# Из-за ограничения длины ответа я не могу привести их здесь, но они идентичны предыдущей версии 4.03,
# за исключением добавления поддержки 'every_hour' в edit_notification_time_handler и list_notifications_handler.
